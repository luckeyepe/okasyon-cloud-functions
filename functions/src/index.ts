...
//Notification//
export const sendTransactionNotificationSupplier = functions.region('asia-northeast1').firestore
    .document("Transaction_Supplier/{supplierUid}/transaction_supplier/{transactionUid}")
    .onCreate(async (snapshot, context) => {
